...
translate spanish_LatAm strings:
    ...
    new "Mis mejores romances son libros"
    ...
    new "Un buen chico de la Convención Rumana de Historia de la Hechicería me llevó a este hermoso lugar. Tuvimos una conversación maravillosa y probamos un delicioso plato de queso exótico."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I wish I'd meet someone as intelligent and funny in my life. Why are other guys not like him?"
    new "Me gustaría conocer a alguien tan inteligente y divertido en mi vida. ¿Por qué otros chicos no son como él?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Miss Amelie, I'm so glad for you! So what about that guy? Isn't he an option? 😍"
    new "{b}Samantha:{/b} Señorita Amelie, ¡me alegro mucho por usted! Entonces, ¿qué pasa con ese tipo? ¿No es una opción? 😍"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} Sam! Students should not gossip about teachers and stuff."
    new "{b}Sabrina:{/b} ¡Sam! Los estudiantes no deben chismear sobre los maestros y esas cosas."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Sorry."
    new "{b}Samantha:{/b} Lo siento."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} So, Amelie, what about that guy?"
    new "{b}Sabrina:{/b} Entonces, Amelie, ¿qué pasa con ese tipo?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's hard to imagine there's someone more intelligent than you, miss Amelie."
    new "Es difícil imaginar que haya alguien más inteligente que usted, señorita Amelie."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Maybe you should not friend zone the only guys who suit your fucking description?!"
    new "¡¿Tal vez no deberías meter a la friend zone a los únicos chicos que se ajustan a tu puta descripción?!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Any place would be better than Romanian Wizardry History Convention."
    new "Cualquier lugar sería mejor que la Convención Rumana de Historia de la Hechicería."
    ...
    new "A veces, incluso el trabajo en la biblioteca puede ser agotador. Gracias a Dios tengo un juego de velas aromáticas y agua tibia calmante esperándome en casa."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} Girl, I can relate. I used to read in the bath too, but the thought of getting the book wet... Horrifying. "
    new "{b}Victoria:{/b} Chica, me identifico. Solía ​​leer en el baño también, pero la idea de mojar el libro... Horrible."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Sabrina:{/b} Come see me when you're out of candles. I have a few exciting aromas. "
    new "{b}Sabrina:{/b} Ven a verme cuando te quedes sin velas. Tengo algunos aromas excitantes."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I hope you'll get enough rest, miss Amelie ❤️"
    new "Espero que descanse lo suficiente, señorita Amelie ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Doesn't it feel lonely to be alone in that king-size bath? I would be honored to help you fix this problem."
    new "¿No se solitaria estando sola en ese baño tamaño king? Sería un honor ayudarte a solucionar este problema."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Got tired of working at the library? You poor thing! Maybe you can switch with coalminers to relax a little?"
    new "¿Te cansaste trabajando en la biblioteca? ¡Pobrecita! ¿Tal vez puedas cambiar lugares con mineros de carbón para relajarte un poco?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It can be so lonely in the library. Aren't there any readers left among the youths?"
    new "Puede ser tan solitario en la biblioteca. ¿No quedan lectores entre los jóvenes?"
    ...
    new "{b}Victoria:{/b} Querida, he visto a dos o tres estudiantes con libros. Así que sí, digamos que están al borde de la extinción."
    ...
    new "{b}Haley:{/b} Estoy seguro de que la gente no se da cuenta de lo divertido que es sumergirse en la biblioteca hasta que haya leído diez o veinte libros mientras busca una respuesta."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Haley, I'm sure people realize it's the opposite of fun."
    new "{b}Elijah:{/b} Haley, estoy seguro de que la gente se da cuenta de que eso es lo opuesto a la diversión."
    ...
    new "Mi lugar favorito para leer es su biblioteca, señorita. Me aseguraré de visitarla más a menudo."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Remind me why I chose the library over the fashion show runway?"
    new "¿Recuérdame por qué elegí la biblioteca en lugar de la pasarela del desfile de modas?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Jacob:{/b} As far as I know you have time for a second job."
    new "{b}Jacob:{/b} Que yo sepa, tienes tiempo para un segundo trabajo."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} Cause you look more like a queen from a fairy tale, that like a cheap cover girl."
    new "{b}Victoria:{/b} Porque pareces más una reina de un cuento de hadas que una chica de portada barata."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Miss Amelie, I'm sure there is a fashion show for librarians. "
    new "Señorita Amelie, estoy segura de que hay un desfile de moda para bibliotecarias."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, I'm a professional photographer. Maybe we can make your dream about a fashion shoot come true? "
    new "Hola, soy fotógrafo profesional. ¿Tal vez podamos hacer realidad tu sueño de una sesión de moda?"
    ...
    new "¿Porque querías salvarte a ti misma de la vergüenza?"
    ...
    new "Una vez, William Shakespeare dijo \"Me gusta este lugar y de buena gana perdería mi tiempo en él\", y eso es exactamente lo que siento por mi biblioteca. Incluso puedo llamarlo \"segundo hogar\"; ni siquiera puedo imaginar mi vida sin él. Quiero pertenecer aquí y pertenezco aquí, todo está en su lugar."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Victoria:{/b} Beautifully said! 🥰"
    new "{b}Victoria:{/b} ¿Hermosamente dicho! 🥰"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} You inspire me a lot, Miss Erhart!"
    new "{b}Haley:{/b} ¡Me inspira mucho, señorita Erhart!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I cannot even imagine the Academy without the library and without you. You're the integral part of it!"
    new "Ni siquiera puedo imaginar la Academia sin la biblioteca y sin ti. ¡Eres la parte integral de ella!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm also interested what William Shakespeare would say about your curves."
    new "También me interesa lo que diría William Shakespeare sobre tus curvas."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Now I'm a frisky little witch not in my mind only!"
    new "¡Ahora soy una pequeña bruja juguetona no solo en mi mente!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Ms. Erhart, you're looking extremely hot in this outfit!"
    new "{b}Elijah:{/b} Sra. Erhart, ¡se ve extremadamente buena con este conjunto!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} Absolutely agree with Elijah."
    new "{b}Audrey:{/b} Totalmente de acuerdo con Elijah."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Do you know how to fly around on a broomstick?"
    new "¿Sabes como volar en una escoba?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Looks like the perfect outfit for the role-playing game if you know what I mean"
    new "Parece el atuendo perfecto para el juego de rol si sabes a lo que me refiero."
    ...
    new "Hola chicos, perdón por no publicar durante tanto tiempo 😅 Entrenando 24\\7. Ya me conoces, cualquier cosa que no sea oro no es una opción."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Keep it up sis! I'm so sorry I can't be there to support you."
    new "{b}Samantha:{/b} ¡Sigue así, hermana! Lamento mucho no poder estar ahí para apoyarte."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} It's alright, sis. I'll send you my first selfie with gold."
    new "{b}Ashley:{/b} Está bien, hermana. Te enviaré mi primer selfie con el oro."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} 😘 deal."
    new "{b}Samantha:{/b} 😘 trato hecho."
    ...
    new "Ashley, estoy muy orgulloso de tu dedicación. Sé que no nos llevamos muy bien, pero quiero que sepas que estoy 100% seguro de que lo tienes."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Wow... [Name]... If it's not a prank - thank you. That means a lot to me. "
    new "Ashley: Wow... [Name]... Si no es una broma, gracias. Eso significa mucho para mí."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: Guys, you're so cute it makes me wanna cry. "
    new "Samantha: Chicos, son tan tiernos que me dan ganas de llorar."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, girl - those curves are golden already. Does it matter what the jury says? "
    new ""Oye, nena, esas curvas ya son de oro. ¿Importa lo que diga el jurado?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Is there anything except sex about you? Come on."
    new "Ashley: ¿Hay algo más que sexo en ti? Vamos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Maybe you should consider switching your focus to Go-Go dancing? "
    new "¿Tal vez deberías considerar cambiar tu enfoque al baile Go-Go?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Fuck off."
    new "Ashley: Vete a la mierda."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Voila! One more glimpse at my future routine: check out new tricks I've been working on! This was actually really fun!"
    new "¡Voila! Un vistazo más a mi futura rutina: ¡mira los nuevos trucos en los que he estado trabajando! ¡Esto fue realmente muy divertido!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b}Oh my gush! Baby, Isn't this dangerous? I'm worried."
    new "{b}Olivia:{/b}¡Oh, Dios mío! Cariño, ¿no es esto peligroso? Estoy preocupada."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b}Don't be stupid, darling. She's a professional, she knows what she's doing!"
    new "{b}Don:{/b}No seas estúpida, cariño. Es una profesional, sabe lo que hace!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow! That looks so cool, Ash!"
    new "¡Guau! ¡Eso se ve genial, Ash!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I can think of a more suitable way to use those ropes with you..."
    new "Puedo pensar en una forma más adecuada de usar esas cuerdas contigo..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "\"Stop and look at yourself in the mirror. Are you happy with what you see?\""
    new "\"Detente y mírate en el espejo. ¿Estás feliz con lo que ves?\""

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Mom gave me that advice when I turned 12. I was chubby kid. I was not happy."
    new "Mamá me dio ese consejo cuando cumplí 12 años. Yo era una niña gordita. No era feliz."
    ...
    new "{b}Olivia:{/b} Todos estamos muy orgullosos de ti, cariño."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Evelyn:{/b} I'm not sure that that was healthy advice, sweetheart!"
    new "{b}Evelyn:{/b} ¡No estoy segura de que ese fuera un consejo saludable, cariño!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} Shut up, Evelyn. Get your child to decide what advice is healthy for them."
    new "{b}Olivia:{/b} Cállate, Evelyn. Deja que tu hijo decida qué consejos son saludables para él."
    ...
    new "{b}Olivia:{/b} ¿Qué? ¡¿Estás de acuerdo con ella?!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} We'll talk in private.\t"
    new "{b}Ashley:{/b} Hablaremos en privado.\t"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It only matters that you're gorgeous inside, Ash."
    new "Solo importa que seas hermosa por dentro, Ash."
    ...
    new "Todavía no entiendo por qué los espejos no se derriten por tu calor."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Stop it, you! I'm blushing already."
    new "Ashley: ¡Basta, tú! Ya me estoy sonrojando."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you that basic? It's sad, honestly."
    new "¿Eres tan básica? Es triste, honestamente."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: You're making any environment around you toxic. Think about it, jerk."
    new "Ashley: Estás haciendo que cualquier entorno a tu alrededor sea tóxico. Piénsalo, idiota."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "So... I wanted to brag about my spacious couch, but I ended up bragging about my curves again. Oops!"
    new "Así que... Quería presumir de mi espacioso sofá, pero terminé presumiendo de nuevo de mis curvas. ¡Ups!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} I don't think posting things like that is the reason we bought you your phone, young lady."
    new "{b}Don:{/b} No creo que publicar cosas como esa sea la razón por la que te compramos tu teléfono, jovencita."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} Dad, come on! It's nothing."
    new "{b}Ashley:{/b} ¡Papá, vamos! No es nada."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Don:{/b} Come into my office. Now. "
    new "{b}Don:{/b} Ven a mi oficina. Ahora."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You just need to hear good things about your curves more often. I'll make sure you do."
    new "Solo necesitas escuchar cosas buenas sobre tus curvas con más frecuencia. Me aseguraré de que lo hagas."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I think you have a gift for photography. This is my favorite photo of a couch!  "
    new "Creo que tienes un don para la fotografía. ¡Esta es mi foto favorita de un sofá!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "This is me approvingly watching you writing me positive comments. Well done, keep it up!"
    new "Este soy yo observándote con aprobación mientras me escribes comentarios positivos. ¡Bien hecho, sigue así!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Things I'd do for sisters approval."
    new "{b}Samantha:{/b} Cosas que haría por la aprobación de mis hermanas."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} I bless you."
    new "{b}Ashley:{/b} Te bendigo."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "😀🥳 - this is as positive as I can get. "
    new "😀🥳 - esto es lo más positivo que puedo conseguir."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Close enough."
    new "Ashley: Lo suficientemente cerca."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Don't you think bragging for likes like this is pathetic?"
    new "¿No crees que presumir de likes así es patético?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Ashley: Do you know you can just ignore the things you don't like?"
    new "Ashley: ¿Sabes que puedes ignorar las cosas que no te gustan?"
    ...
    new "{b}Don:{/b} No creo que te compremos un teléfono por publicar fotos como esa. ¡Tenemos que hablar, en mi oficina, ahora!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Olivia:{/b} Don, she is a grown woman and it's absolutely okay. Baby, you're gorgeous!"
    new "{b}Olivia:{/b} Don, ella es una mujer adulta y está absolutamente bien. Cariño, ¡eres hermosa!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "In your eyes, of course! "
    new "¡Tus ojos, por supuesto!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Let's be honest - 99% check out your boobs. And I can say that it worth looking at!"
    new "Seamos honestos: el 99% mira tus senos. ¡Y puedo decir que vale la pena mirarlo!"
    ...
    new "La pantalla de mi teléfono, ¿no es obvio?"
    ...
    new "{b}Samantha:{/b} ¡Feliz de reunirme con mi mejor amiga!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You look lovely together ☺️"
    new "Se ven encantadoras juntas ☺️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "What do I have to do to get that look from you, baby?"
    new "¿Qué tengo que hacer para obtener esa mirada de ti, nena?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you sure this is the best photo you've got?"
    new "¿Estás segura de que esta es la mejor foto que ustedes tienen?"
    ...
    new "La feria medieval fue interesante, pero claramente les faltaba un poco de misterio extra. ¡Decidí darles una mano! ¿Qué os parece mi disfraz?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} WTF... Those wings look so natural."
    new "{b}Elijah:{/b} ¿Qué caraj...?... Esas alas se ven tan naturales."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} @Elijah +1. Your costume is fantastic! I'm so glad we've bought it."
    new "{b}Samantha:{/b} @Elijah +1. ¡Tu disfraz es fantástico! Estoy tan contenta de haberlo comprado."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I love how this costume suits your hair!"
    new "¡Me encanta cómo este disfraz combina con tu cabello!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow... I think you've accidentally stolen all the attention."
    new "Wow... Creo que accidentalmente has robado toda la atención."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I don't want to go medieval on you, so I won't say anything about your look."
    new "No quiero volverme medieval contigo, así que no diré nada sobre tu apariencia."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You  never know what's waiting around the darkest corner. Maybe it's me..."
    new "Nunca sabes lo que te espera en el rincón más oscuro. Quizás soy yo..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Would you dare to take a closer look? "
    new "¿Te atreverías a echar un vistazo más de cerca?"
    ...
    new "¿Cómo puede haber un rincón más oscuro si tus ojos brillan tanto?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm not sure I'm going to stop at just looking."
    new "No estoy seguro de que me voy a detener en solo mirar."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Nah, it's too creepy..."
    new "Nah, es demasiado espeluznante..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Paid a visit to my old haters.... And people who sent me dick pics 🤬"
    new "Le hice una visita a mis viejos haters... Y a las personas que me enviaron fotos de penes 🤬"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Seriously, what's wrong with you, guys? I'm more turned on by looking at this gravestone than by receiving this trash."
    new "En serio, ¿qué les pasa, chicos? Me excita más mirar esta lápida que recibir esa basura."
    ...
    new "Diría que preferiría que me invitaras a una cita, pero para ser honesto, ¡preferiría que dejaras de molestarme en absoluto! Por favor, arrástrate en algún rincón oscuro y muérete ya."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Yeah, you can send me those dick pics instead. "
    new "{b}Elijah:{/b} Sí, puedes enviarme esas fotos de penes en su lugar."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} That's a joke, guys. "
    new "{b}Elijah:{/b} Es una broma, chicos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I'm totally with you on this. Men are disgusting."
    new "Estoy totalmente contigo en esto. Los hombres son asquerosos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You know that there is no sign that dick pics are not welcomed in your private?"
    new "¿Sabes que no hay ninguna señal de que las fotos de pollas no sean bienvenidas en tu privacidad?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Every girl has her secrets. Are you sure you can unravel mine? Many have tried and ended up like Yorick."
    new "Cada chica tiene sus secretos. ¿Estás seguro de que puedes desentrañar el mío? Muchos lo han intentado y han terminado como Yorick."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Maybe you should not brag about secrets if you don't want people to snoop around?"
    new "{b}Samantha:{/b} ¿Quizás no deberías alardear de tus secretos si no quieres que la gente husmee?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Ashley:{/b} What's the fun in that?"
    new "{b}Ashley:{/b} ¿Qué tiene eso de divertido?"
    ...
    new "{b}Jacob:{/b} Uno de tus mayores misterios es cómo te las arreglas para no ser expulsado si no terminas tu trabajo final."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hey, sometimes it's worth the risk. I think you're just that case."
    new "Oye, a veces vale la pena el riesgo. Creo que eres justo ese caso."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: It's nice to see you guys get along so well."
    new "Samantha: Es bueno ver que se llevan tan bien."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Audrey: We don't."
    new "Audrey: No lo hacemos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The only secret is who gives likes to shitposts like that."
    new "El único secreto es quién le da likes a publicaciones de mierda como esa."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Samantha: [Name]! What's wrong with you?"
    new "Samantha: [Name]! ¿Qué sucede contigo?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I am getting myself in shape. In shape of a scorching hot chick! "
    new "Me estoy poniendo en forma. En forma de una chica caliente abrasador!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I hope I won't get the academy on fire."
    new "Espero no incendiar la academia."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} Hey, wow! I have the same sport's top!"
    new "{b}Lily:{/b} ¡Hola, guau! ¡Tengo el mismo peto deportivo!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Too hot for this app. "
    new "{b}Elijah:{/b} Demasiado caliente para esta app."
    ...
    new "Siempre es inspirador ver cuando una mujer perfecta trabaja duro para ir más allá de la perfección."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Audrey: I'm uncomfortable with getting compliments. Go away."
    new "Audrey: Me incomoda recibir cumplidos. Piérdete."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I wish I could spend more time in a gym last summer."
    new "Ojalá hubiera podido pasar más tiempo en el gym la semana pasada."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Audrey: Your minor injury is not an excuse for laziness."
    new "Audrey: Tu lesión menor no es una excusa para la pereza."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "This summer's discovery: Yoga."
    new "El descubrimiento de este verano: Yoga."
    ...
    new "Siento una paz y armonía que nunca antes había experimentado. Nunca hubiera pensado que cuerpo y alma estuvieran tan fuertemente conectados. Gracias por el consejo, Samantha."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Become one with your inner spirit."
    new "{b} Samantha: {/ b} Conviértete en una con tu espíritu interior."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} I don't know. Aren't you afraid of inner demons?"
    new "{b}Elías:{/b} No lo sé. ¿No tienes miedo de los demonios internos?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Audrey:{/b} You can't even imagine..."
    new "{b}Audrey:{/b} Ni siquiera puedes imaginar..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "One look at this picture fills me with harmony. Or, well, maybe those are some other feelings 😈 "
    new "Una mirada a esta imagen me llena de armonía. O, bueno, tal vez esos son algunos otros sentimientos 😈"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Isn't yoga a juhe waste of money and time with no confirmed effect?"
    new "¿No es el yoga una gran pérdida de dinero y tiempo sin ningún efecto confirmado?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I feel the need... the need for speed."
    new "Siento la necesidad, la necesidad de velocidad."
    ...
    new "Ayer un tipo me dijo que las chicas en moto son las más calientes. ¿Crees que es realmente así, o simplemente trató de coquetear conmigo? 😈"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Your friend is so right! But desire to hook up with you also makes sense..."
    new "{b}Elijah:{/b} ¡Tu amigo tiene mucha razón! Pero el deseo de ligar contigo también tiene sentido..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Only look at her! I love you so much, Audrey! ❤️"
    new "{b}Samantha:{/b} ¡Solo mírala! ¡Te quiero mucho, Audrey! ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Awesomeness of this photo is just off the charts!"
    new "¡La genialidad de esta foto está fuera de serie!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Can my belief that girls on motorcycles are the hottest help me somehow to make a pass at you? "
    new "¿Puede mi creencia de que las chicas en moto son las más atractivas ayudarme de alguna manera a insinuarme?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Let me see those likes!"
    new "¡Déjame ver esos likes!"
    ...
    new "¡El primer día como prefecto de Leonhearts fue genial! ¡Mira estos ojos prometedores de nuestro nuevo estudiante y mi amigo [Name]! ¡Hacia un futuro brillante, vamos!
"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} ha-ha, [Name] looks so silly here!"
    new "{b}Haley:{/b} ¡ja-ja, [Name] parece tan tonto aquí!
"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} True. You guys are cute ❤️"
    new "{b}Lily:{/b} Cierto. Ustedes son lindos ❤️"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Thanks, buddy. Glad that you are my prefect."
    new "Gracias amigo. Me alegro de que seas mi prefecto."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Delete this. Now."
    new "Borrar esto. Ahora."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "At first I was afraid I'd look bad, but next to you, I look handsome)."
    new "Al principio tenía miedo de quedar mal, pero a tu lado me veo guapo)."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "1 book a day and it's okay"
    new "1 libro al día y está OK"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "What could be more satisfying than gliding on ice while the wind flutters your hair? "
    new "¿Qué podría ser más satisfactorio que deslizarse sobre el hielo mientras el viento agita tu cabello?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I think I could do this forever. How do you take a break from your studies?"
    new "Creo que podría hacer esto para siempre. ¿Cómo te tomas un descanso de tus estudios?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} I love skiing too!"
    new "{b}Lily:{/b} ¡A mí también me encanta patinar!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} It's too soon to take any breaks from studies, young lady."
    new "{b}Elijah:{/b} Es demasiado pronto para descansar de los estudios, jovencita."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Kidding! I prefer snowboarding; it just seems more remarkable."
    new "{b}Elijah:{/b} ¡Es broma! prefiero el snowboard; simplemente parece más notable."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I used to play soccer before, after, and even instead of school."
    new "Solía ​​jugar al fútbol antes, después e incluso en lugar de la escuela."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You look incredible on ice skates!"
    new "Te ves increible en patines de hielo"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Scrolling through my Lustagram feed, mostly..."
    new "Desplazándome por mi feed de Lustagram, principalmente..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I read that a person's real beauty is on the inside, not the outside. What is the first thing you pay attention to?"
    new "Leí que la verdadera belleza de una persona está en el interior, no en el exterior. ¿Qué es lo primero a lo que le prestas atención?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} It works that way with ugliness too. If someone looks like a candy, it does not mean he does not taste sour."
    new "{b}Elijah:{/b} También funciona de la misma manera con la fealdad. Si alguien parece un caramelo, no significa que no sepa agrio."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} @Elijah That's true..."
    new "{b}Haley:{/b} @Elijah Eso es cierto..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Yeah, every person deserves a chance, no matter the looks..."
    new "Sí, todas las personas merecen una oportunidad, sin importar el aspecto..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Lucky, you've got both."
    new "Suerte, tienes ambos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's usually two big things in the front and one on the back. Why?"
    new "Por lo general, son dos cosas grandes en el frente y una en la parte posterior. ¿Por qué?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Do I look like I've grinded through five textbooks in one night? Because that's what I did, Yay!"
    new "¿Parezco como si hubiera leído cinco libros de texto en una noche? Porque eso es lo que hice, ¡Yay!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} I'm sorry, was #Funnight a mistake, or why am I here, reading about reading? Ugh..."
    new "{b}Elijah:{/b} Lo siento, #Funnight fue un error o ¿por qué estoy aquí, leyendo sobre lectura? Puaj..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} That's a tremendous amount of books. How do you read so fast?"
    new "{b}Lily:{/b} Esa es una enorme cantidad de libros. ¿Cómo lees tan rápido?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} Practice, I guess..."
    new "{b}Haley:{/b} Practica, supongo..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow! I'd have to spend a whole week if I were to finish five textbooks..."
    new "¡Guau! Tendría que pasar una semana entera si tuviera que terminar cinco libros de texto..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "So that's your secret? I hope all models will read that much at night because you've even more beautiful than usual."
    new "Entonces ¿ese es tu secreto? Espero que todas las modelos lean tanto por la noche porque estás aún más hermosa que de costumbre."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I stayed last night reading too! Got five comic books done in no time."
    new "Yo también me quedé anoche leyendo! Hice cinco cómics en muy poco tiempo."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "About how fast things change:"
    new "Acerca de qué tan rápido cambian las cosas:"
    ...
    new "En el verano, yo era la persona más solitaria del mundo. Mis padres no me entendían, mis amigas me traicionaban y nunca encontré un amigo con quien hablar."
    ...
    new "Cómo sonrío todos los días. Tengo muchos amigos nuevos a mi alrededor, estoy en el lugar más increíble del mundo y está este chico... No, no nos apresuremos a sacar conclusiones con un chico todavía 😅"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Anyway, if life is like a box of chocolates, this fall I haven't had any bad ones yet."
    new "De todos modos, si la vida es como una caja de bombones, este otoño todavía no he tenido ninguno malo."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I wish you a white streak, too."
    new "Yo también te deseo una buena racha."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} That's very sweet. We're here for you."
    new "{b}Samantha:{/b} Eso es muy dulce. Estamos aquí para tí."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Hey, you are too beautiful to have those sad thoughts. We won't let that happen again. Welcome to the family."
    new "{b}Elijah:{/b} Oye, eres demasiado hermosa para tener esos pensamientos tristes. No permitiremos que eso vuelva a suceder. Bienvenido a la familia."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} Thank you, guys."
    new "{b}Haley:{/b} Gracias, chicos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley, you're a great friend, and you deserve to smile every day! "
    new "¡Haley, eres una gran amiga y mereces sonreír todos los días!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Thank's! Friend 👀"
    new "Haley: ¡Gracias! Amigo 👀"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Are you sure you don't want to rush to any action with that guy? "
    new "¿Estás segura de que no quieres precipitar ninguna acción con ese chico?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: I haven't said anything about action 🤭"
    new "Haley: No he dicho nada sobre acción 🤭"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's been not so long since you've got here. I'm sure there's something that can spoil those feelings."
    new "No ha pasado tanto tiempo desde que llegaste aquí. Estoy seguro de que hay algo que puede estropear esos sentimientos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Hey! I do not need this kind of mood right now. Sorry."
    new "Haley: Oye! No necesito este tipo de estado de ánimo en este momento. Lo siento."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Hello from the living room of our dorm! Ready to study!"
    new "¡Hola desde la sala de nuestro dormitorio! Listo para estudiar!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} You should see this place when we party."
    new "{b}Elijah:{/b} deberías ver este lugar cuando celebramos"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow, our living room looks much more beautiful in your picture. What kind of filters are you using? "
    new "Wow, nuestro salón se ve mucho más bonito en tu foto. ¿Qué tipo de filtros estás utilizando?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: 100% me, baby."
    new "Haley: 100% yo, nene."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Anyone else bored of seeing selfies? Put some imagination into making photos, lady."
    new "¿Alguien más aburrido de ver selfies? Ponga un poco de imaginación en hacer fotos, señorita."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Audrey: Hey, Jackass, leave this baby girl alone! Nice photo, Haley. Would you mind not listening to him?"
    new "Audrey: ¡Oye, idiota, deja en paz a esta bebesita! Bonita foto, Haley. ¿Te importaría no escucharlo?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Check out my room! Well, only half of the room is mine, and you can see it right here. "
    new "¡Mira mi habitación! Bueno, solo la mitad de la habitación es mía, y puedes verlo aquí mismo."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "It's light and cozy, and my roommate is the sweetest person I've ever met. I'm so excited to live here!"
    new "Es luminoso y acogedor, y mi compañera de cuarto es la persona más dulce que he conocido. ¡Estoy tan emocionada de vivir aquí!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} That's so sweet, baby! I like you too!"
    new "{b}Lily:{/b} ¡Qué dulce, cariño! ¡Tú también me encantas!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} Take a good care of my old room, I loved living there."
    new "{b}Samantha:{/b} Cuida bien mi antigua habitación, me encantaba vivir allí."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} I will."
    new "{b}Haley:{/b} Lo haré"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Wow! Your room is so bright and cozy! I like it! "
    new "¡Guau! ¡Tu habitación es tan luminosa y acogedora! ¡Me gusta!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Thanks! You're welcomed to visit! "
    new "Haley: ¡Gracias! ¡Eres Bienvenido para visitarnos!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The main question is - how sturdy is your bed? "
    new "La pregunta principal es: ¿qué tan resistente es tu cama?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Why?',' Haley: Oh! I got it! Ew!!!! "
    new "Haley: ¿Por qué?', 'Haley: ¡Oh! ¡Lo tengo! ¡Ew"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Your room is much brighter and cozier than mine. I'm depressed. "
    new "Nuestra habitación es mucho más luminosa y acogedora que la mía. Estoy deprimido."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Is it that bad, sweety? I'll help you redecorate if you want 💪."
    new "Haley: ¿Es tan malo, cariño? Te ayudo a redecorar si quieres 💪."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "The best way to take a break from studies is to make a selfie. Do I look like I'm ready to ace the test?"
    new "La mejor forma de tomarse un descanso de los estudios es hacerse un selfie. ¿Me veo como si estuviera listo para aprobar el examen?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} You look like you're ready to ace all the tests. Should I already celebrate Leonhearts victory?"
    new "{b}Lily:{/b} Parece que estás lista para superar todas las pruebas. ¿Debería ya celebrar la victoria de Leonhearts?"
    ...
    new "{b}Victoria:{/b} Señorita Ranger, estoy segura de que lo sabe mejor, pero dedicar tanto tiempo a la teoría no le dejará tiempo para practicar."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Haley:{/b} Don't worry, miss Lapis. I'm confident in my spellcasting."
    new "{b}Haley:{/b} No se preocupe, señorita Lapis. Confío en mi lanzamiento de hechizos."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You always look like you're ready to ace everything, girl!"
    new "¡Siempre pareces estar lista para triunfar en todo, chica!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Aww, that's so nice, [Name]. ty..."
    new "Haley: Aww, eso es muy bueno, [Name]. gracias..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I never thought that a girl in a library could look so hot."
    new "Nunca pensé que una chica en una biblioteca pudiera verse tan sexy."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: Glad I've changed your mind. I'm not too fond of those old stereotypes about library-type girls."
    new "Haley: Me alegro de haberte hecho cambiar de opinión. No me gustan demasiado esos viejos estereotipos sobre las chicas de biblioteca."
    ...
    new "¡Hay tantas cosas y criaturas interesantes aquí en el Cordale! Pero ten cuidado en tu aventura, este ángel me acaba de dar un susto de muerte..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} What's this place? I didn't know we have something like that in the Academy. We should go there!"
    new "{b}Lily:{/b} ¿Qué es este lugar? No sabía que teníamos algo así en la Academia. ¡Deberíamos ir allí!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Thank you for a walk, Haley! I really enjoy it."
    new "¡Gracias por un paseo, Haley! Realmente lo disfruté."
    ...
    new "Nunca pensé que esa Murble alguna vez me excitaría..."
    ...
    new "Es tan agradable saber que siempre estoy rodeada de libros: incluso en nuestro campus hay una pequeña biblioteca en la que siempre encuentro algo interesante."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "My last discovery - \"Fantastic Beasts and Where to Find Them\". EVERYONE should read it!"
    new "Mi último descubrimiento - \"Animales fantásticos y dónde encontrarlos\". ¡TODOS deberían leerlo!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Samantha:{/b} I've already read it and can say that it's amazing!"
    new "{b}Samantha:{/b} ¡Ya lo he leído y puedo decir que es increíble!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Elijah:{/b} Do you write a blog only about books or what?"
    new "{b}Elijah:{/b} ¿Escribes un blog solo sobre libros o qué?"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "You're such a cutie!"
    new "¡Eres una lindura!"
    ...
    new "Podemos leerlo juntos, en un ambiente más íntimo..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: But I've already read it."
    new "Haley: Pero ya lo leí."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I know where you can find fantastic beasts - in our living room!"
    new "Sé dónde puedes encontrar animales fantásticos: ¡en nuestra sala de estar!"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Haley: that's not funny."
    new "Haley: eso no es gracioso."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Leonheart for life"
    new "Leonheart de por vida"

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "Had a picnic with my family the day before I left. Already I miss them and the carefree days of summer...   "
    new "Hice un picnic con mi familia el día antes de irme. Ya los extraño a ellos y a los días despreocupados del verano..."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Naomi:{/b} We might be able to have a picnic this weekend somehow."
    new "{b}Naomi:{/b} Es posible que podamos hacer un picnic este fin de semana de alguna manera."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "{b}Lily:{/b} That's a great idea!"
    new "{b}Lily:{/b} ¡Es una gran idea!"
    ...
    new "Estoy tan feliz de que al menos hayas tenido un poco de descanzo de tu trabajo."

    # game/logic/phone_interface/lustogram_db.rpy:44
    old "I envy the photographer! Such a spectacular view of your curves!"
    new "¡Envidio al fotógrafo! ¡Qué vista tan espectacular de tus curvas!"
